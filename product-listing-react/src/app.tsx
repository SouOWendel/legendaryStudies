...
export default function App() {
	...
	// Data is the return of function of queryFn (query function);
	const { data: tagsResponse, isLoading } = useQuery<TagResponse>({
		...
		queryKey: ['get-tags', urlFilter, page], // identificação
		placeholderData: keepPreviousData, // manter os dados anteriores e não piscar a pagina
		staleTime: 1000 * 60, // mantem o cache por 60s
	});
